...
function to_light(){
    document.getElementById("mainlogo1").setAttribute("src", "https://github.com/malikgaurav626/Project-HistoryHaryana/logos/haryana9.png");
    document.getElementById("mainlogo").setAttribute("src", "https://github.com/malikgaurav626/Project-HistoryHaryana/logos/haryana4-light.png");
    document.getElementById("small-screen-logo").setAttribute("src", "https://github.com/malikgaurav626/Project-HistoryHaryana/logos/haryana-light.png");
...
function to_dark(){
    document.getElementById("mainlogo1").setAttribute("src", "https://github.com/malikgaurav626/Project-HistoryHaryana/logos/haryana7.png");
    document.getElementById("mainlogo").setAttribute("src", "logos/haryana4.png");
    document.getElementById("small-screen-logo").setAttribute("src", "https://github.com/malikgaurav626/Project-HistoryHaryana/logos/haryana.png");
...
function to_dark_2(){
    document.getElementById("mainlogo1").setAttribute("src", "https://github.com/malikgaurav626/Project-HistoryHaryana/logos/haryana7.png");
    document.getElementById("mainlogo").setAttribute("src", "https://github.com/malikgaurav626/Project-HistoryHaryana/logos/haryana4.png");
    document.getElementById("small-screen-logo").setAttribute("src", "https://github.com/malikgaurav626/Project-HistoryHaryana/logos/haryana.png");
    document.getElementById("scroll-logo").style.color = "#e03c3c";
