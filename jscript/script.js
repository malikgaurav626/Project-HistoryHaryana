...
function to_light(){
    document.getElementById("mainlogo1").setAttribute("src", "logos/Haryana9.png");//h9
    document.getElementById("mainlogo").setAttribute("src", "logos/Haryana4-light.png");//4light
    document.getElementById("small-screen-logo").setAttribute("src", "logos/haryana-light.png");//light
